...
class FairModePage extends Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <View>
                    <Text style={styles.sub_heading}> Fair Mode </Text>
                ...
                <View style={styles.button_wrapper}>
                    <Button bordered style={styles.btn} onPress={() => alert("Sales memo")}><Text style={styles.text}> Fair Mode </Text></Button>
                </View>
                <View>
                    <Picker style={{ borderWidth: 2 }}
