    ...
    render() {
        ...
        return (
            <View style={{ padding: 10 }}>
                ...
                <View>
                    <Text style={styles.title_report}> Stock Take-Report  </Text>
                    <View style={styles.button_wrapper}>
                        <Button bordered style={styles.btn} onPress={() => alert("SCANNER")}><Text style={styles.text}> Scanner </Text></Button>
                        <Button bordered style={styles.btn} onPress={() => alert("Report")}><Text style={styles.text}> Report </Text></Button>
                    </View>
                </View>
                <View>
                    <Picker style={{ borderWidth: 2 }}
