          ...
          renderRow={(rowData) =>
            <View elevation={5} style={styles.item} >
              <View style={styles.card}>
                <Image source={require('../assets/img/download.jpg')} style={styles.cardImage} />
                <View style={styles.titlePointHolder}>
                  <View style={styles.productTitle}>
                    <View>
                      <Text style={{ marginLeft: 20, fontWeight: 'bold' }}>Product title </Text>
                    </View>
                  </View>
                ...
                <View style={styles.titlePointHolder}>
                  <View style={styles.productTitle}>
                    <View>
                      <Text style={{ marginLeft: 20, fontWeight: 'bold'  }}>Accumulated </Text>
                    </View>
                  </View>
                  <View style={styles.productPoint}>
                    <View>
                ...
                <View style={styles.productTitle}>
                  <View>
                    <Text style={{ marginLeft: 20, fontWeight: 'bold'  }}>Balance </Text>
                  </View>
                </View>
                <View style={styles.productPoint}>
                  <View>
